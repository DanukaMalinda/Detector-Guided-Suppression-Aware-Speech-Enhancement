...
def main():
    ...
    # 1. Read rank info
    # ---------------------------
    # local_rank = int(os.environ["LOCAL_RANK"])   # CHANGE HERE
    # rank       = int(os.environ["RANK"])         # CHANGE HERE
    # world_size = int(os.environ["WORLD_SIZE"])   # CHANGE HERE

    # # ---------------------------
    # # 2. Set device
    # # ---------------------------
    # torch.cuda.set_device(local_rank)            # CHANGE HERE
    # device = torch.device(f"cuda:{local_rank}")  # CHANGE HERE
